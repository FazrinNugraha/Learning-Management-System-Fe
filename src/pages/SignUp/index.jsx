      ...
      <div className="flex items-center justify-center gap-[109px] my-auto">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.name?.message && ( <p className='text-red-500 text-xs px-5'> {errors.name?.message} </p> )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.email?.message && ( <p className='text-red-500 text-xs px-5'> {errors.email?.message} </p> )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.password?.message && ( <p className='text-red-500 text-xs px-5'> {errors.password?.message}</p> )}
          </div>
