...
export default function SigninPage({ type = "manager" }) {
  ...
  return (
    <div className="relative flex flex-col flex-1 p-[10px]">
      ...
      >
        <div>
          <h1 className="font-bold text-xl md:text-[26px] leading-[32px] md:leading-[39px] text-white">
            Welcome Back!
          </h1>
          <p className="text-[#6B6C7F] text-sm md:text-base">
        ...
        {errors.email?.message && (
          <p className="text-red-500 text-xs px-4 md:px-5">
            {" "}
            {errors.email?.message}{" "}
          </p>
        )}
        ...
        <div>
          ...
          <div className="flex justify-end mt-[10px]">
            <Link
              to="#"
              className="text-xs md:text-sm leading-[18px] md:leading-[21px] text-[#662FFF] hover:underline"
            >
              Forgot Password
            </Link>
          </div>
        ...
        >
          Sign In to {type === "manager" ? "Manager" : "Student"} Dashboard
        </button>
      </form>
    </div>
  );
